...
from model.relaxation.prompt.config import TRANSFORMERS_MODEL_CONFIG


class AdaptedAttention(nn.Module):
    """This module wraps a LLamaAttention module and injects adaption prompts."""

    def __init__(self, model_type: str, adapter_len: int, model, rotary_emb):
        """
        Initialize object.
        ...
        self.model.num_heads = self.model.config.num_attention_heads
    ...
    def forward(self, **kwargs):
        ...
        query_states = compute_query_states(model=self.model, rotary_emb=self.rotary_emb, **kwargs)
